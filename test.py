...
class EPRPairGeneration(ThreeDScene):
    def construct(self):
        ...
        bloch_radius = 1.5
        bloch1 = self.create_bloch_sphere(label="Qubit A")
        bloch2 = self.create_bloch_sphere(label="Qubit B")
        ...
        self.play(
            ...
            arrow_a.animate.scale(shrink_factor),
            arrow_b.animate.scale(shrink_factor),
            run_time=2
        )
        self.wait(1)
